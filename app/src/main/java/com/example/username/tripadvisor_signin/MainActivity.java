 ...
 *
 *  User sign in to their TripAdvisor Account via Google Sign-In
 *
 *  This Google Api keeps user loging in unless user logs out manually
 */

public class MainActivity extends AppCompatActivity {

    // =================================================== //
    // These Variables are used for Aithentication
